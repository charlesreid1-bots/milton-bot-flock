...
```
$ doker run -d \
    --name stormy_milton_singleton \
    -v ${PWD}/bot/apikeys.py:/milton/bot/apikeys.py \
    -v ${PWD}/bot/keys:/milton/bot/keys \
    miltonbotflock
```
...
modify the docker-compose service `milton_botflock`
...
```
$ docker-compose run stormy_milton
```
